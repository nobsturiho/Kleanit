...
def clean(data):
    ...
    district_keywords = {
        'Lwengo': ['lwengo','mbirizi','kyamuyunga','bukyanagandi','kapochi','katuulo','kyasenya','mweru','kanku','lubaale b',
                   'nakyenyi','lubanda','kitawuluzi','buyingo'],
        'Kalungu': ['kalungu','lukaya','kibisi','bugonzi','mulo'],
        ...
        'Kyankwanzi': ['kyankwanzi','muziranduru','byerima a','kigambanankwale','lwanjale b','guwe'],
        ...
        'Luweero': ['luwero','luweero','wobulenzi','kiwogozi','musaale','nakikoota','nakabiito','kalongo miti','kabakedi',
                    ...
                    'ndibulungi','kibanyi','mabuye','nkiga','lumu','bunyaaka','lusenke','mawu-nsavu'],
        ...
        'Kampala': ['kampala', 'mpala','ben kiwanuka', 'nateete', 'katwe','city centre','kawempe','kabalagala','nakulabye','nakawa',
                   ...
                   'kisasi','bulabira','kabuusu','namirembe','kavule','kibuye','nakasero','kifumbira','kyambogo','gogonya',
                    'salaama','nakinyuguzi','kyebando','kitante','kirombe'],
        ...
        'Mityana': ['mityana','busunju','kitongo','nakanyenya','kakindu','mbaliga','kikandwa','kannyagoga','kiryokya','mpiriggwa',
                   'kyesengeze','kawanga','nakitolo','mpirigwa','zigoti','gginzi'],
        ...
        'Rakai': ['rakai','kasensero','mitukula','kiruuli','kabaseke','kiyooza','lwentulege'],
        ...
        'Nwoya': ['pawatomero','owak cell','paja a'],
        ...
        'Bukomansimbi': ['bukomansimbi','ndebwe'],
        'Budaka': ['budaka'],
        ...
        'Kitgum': ['kitgum'],
        'Kanungu': ['kanung'],
        'Kiboga': ['kiboga','kikooba','kiganzi cell','kikajjo east','masodde','kajjere','namunyuka'],
        'Kapchorwa': ['kapchorwa'],
        'Kween':['kween'],
        ...
        'Jinja': ['jinja','bugembe','kyamagwa','budondo,','karongo'],
